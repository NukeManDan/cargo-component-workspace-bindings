...
mod bindings;
use bindings::exports::ss::responder::base64::Guest as Base64Guest;
use bindings::exports::ss::responder::ckcompact_dr_kdf::Guest as CkCompactGuest;
bindings::export!(App with_types_in bindings);

struct App;

impl Base64Guest for App {
